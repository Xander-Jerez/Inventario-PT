        ...
        return (
            <div className="w-100 m-auto" >
                ...
                <div className="w-75 d-flex align-items-center">
                    <button className="btn btn-primary ms-3 mt-2 " onClick={()=>{router.push("producto/registrar")}} >Registrar Producto</button>
                                ...
                                if (producto.cantidad==0 ) {
                                    return(
                                        <tr className="text-center" key={idx}>
                                            ...
                                            <td>
                                                <button className="btn btn-success" onClick={()=>{router.push(`producto/modificar/${producto._id}`)}} >Modificar</button>
